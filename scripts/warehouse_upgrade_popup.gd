...
@export var all_warehouse_available_upgrades_starting_setup: Array[CardData]
@export var all_warehouse_performed_upgrades_starting_setup: Array[CardData]
...
func _ready() -> void:
	...
	if Global.all_warehouse_available_upgrades.is_empty() and Global.all_warehouse_performed_upgrades.is_empty():
		Global.all_warehouse_performed_upgrades = all_warehouse_performed_upgrades_starting_setup.duplicate()
		Global.all_warehouse_available_upgrades = all_warehouse_available_upgrades_starting_setup.duplicate()
...
func refresh_popup():
	...
	Global.all_warehouse_available_upgrades.sort_custom(func(a, b):
	...
	popola_lista(available_upgrades_container, Global.all_warehouse_available_upgrades, false, purchased_ids)
...
func get_purchased_ids() -> Array:
	var ids = []
	for data in Global.all_warehouse_performed_upgrades:
		if data:
